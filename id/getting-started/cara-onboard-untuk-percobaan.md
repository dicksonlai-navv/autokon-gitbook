...
{% hint style="info" %}
Silakan [pesan panggilan penemuan](https://tidycal.com/dickson/unit-handover-inspection-demo-with-autokon) dengan kami untuk membahas tentang minat Anda melakukan percobaan bersama kami.
{% endhint %}
...
* Membuat grup WhatsApp dengan PIC untuk koordinasi dan dukungan.
* [Informasi proyek](https://form.jotform.com/241931776009460) dimuat sebelumnya ke dalam sistem AutoKon.
* PIC Pengembang dan PIC Kontraktor menerima kredensial login.
