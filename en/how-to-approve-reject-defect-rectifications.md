---
description: >-
  Follow these simple steps to approve or reject defect rectifications notified
  by the Real Estate Developer.
icon: thumbs-up
---

# How To Approve/Reject Defect Rectifications
...
Click the link in the email to access details of the defect on the website.

## Step 3: Log In (If Required)

Log in if prompted. For instructions, check out [“How To Login"](https://autokon.gitbook.io/autokon-wiki/customers/how-to-login).

## **Step 4:** Review the Defect Details
