---
description: >-
  Follow these simple steps to send a WhatsApp notification to customers whose
  units are ready for inspection and to make a booking to inspect the unit
  onsite.
icon: calendar-circle-plus
---

# How To Send Request To Schedule For Unit Inspection

## Step 1: Go to Schedule Management
...
Locate and select a single unit or multiple units to send request to schedule for Unit Inspection.

{% hint style="info" %}
Tip: Apply the filter to display only units with the status “Waiting”.
{% endhint %}
