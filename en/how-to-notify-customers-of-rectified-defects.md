---
description: >-
  Follow these simple steps to notify customers to review the completed defect
  rectification.
icon: message-exclamation
---

# How To Notify Customers Of Rectified Defects

## Step 1: Go to the Defects Management
...
Find and click “View Details” on the unit with defects that are pending verification.

## **Step 3: Filter and Select Defect**

Browse through the list of rectified defects with status “Pending Verification” and click “View Details” on the defect.
...
Ensure that each defect has updated **photos, status.**
